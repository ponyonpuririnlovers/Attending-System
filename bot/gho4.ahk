...
CheckPosition:
    ...
    Else
    {
        ...
        PixelSearch, StartCharacterX, StartCharacterY, CharacterX - AbsX , StartCharacterY - AbsY, StartCharacterX + AbsX , StartCharacterY + AbsY , 0xA4318C, 1, Fast
        If ErrorLevel
        {
...
EnemyCheckStand:
    ...
    PixelSearch, StartCharacterXStand, StartCharacterYStand, CharacterX2 - 200 , CharacterYStand - 100, CharacterXStand + 200 , CharacterYStand + 100 , 0xA4318C, 1, Fast
    If ErrorLevel
    {
        SkillEnable1 := 0
        SkillEnable2 := 0
