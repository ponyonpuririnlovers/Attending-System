...
CheckPosition:
    ...
    Else
    {
        ...
        PixelSearch, StartCharacterX, StartCharacterY, CharacterX - AbsX , StartCharacterY - AbsY, StartCharacterX + AbsX , StartCharacterY + AbsY , MonsterColour, 1, Fast
        If ErrorLevel
        {
...
EnemyCheckStand:
    PixelSearch, CharacterXStand, CharacterYStand, 62, 256, 920, 650, 0xF7F7FF, 1, Fast  
    If ErrorLevel
    {
        SkillEnable1 := 0
        SkillEnable2 := 0
    ...
    PixelSearch, StartCharacterXStand, StartCharacterYStand, CharacterX2 - 200 , CharacterYStand - 100, CharacterXStand + 200 , CharacterYStand + 100 , MonsterColour, 1, Fast
    If ErrorLevel
    {
        SkillEnable1 := 0
        SkillEnable2 := 0
